...
#include "ProjectVerbMessageHelpers.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(ProjectVerbMessageHelpers)

//////////////////////////////////////////////////////////////////////
// FProjectVerbMessage

FString FProjectVerbMessage::ToString() const
{
	FString HumanReadableMessage;
	FProjectVerbMessage::StaticStruct()->ExportText(/*out*/ HumanReadableMessage, this, /*Defaults=*/ nullptr, /*OwnerObject=*/ nullptr, PPF_None, /*ExportRootScope=*/ nullptr);
...
APlayerState* UProjectVerbMessageHelpers::GetPlayerStateFromObject(UObject* Object)
{
...
APlayerController* UProjectVerbMessageHelpers::GetPlayerControllerFromObject(UObject* Object)
{
	if (APlayerController* PC = Cast<APlayerController>(Object))
	{
		return PC;
...
FGameplayCueParameters UProjectVerbMessageHelpers::VerbMessageToCueParameters(const FProjectVerbMessage& Message)
{
...
FProjectVerbMessage UProjectVerbMessageHelpers::CueParametersToVerbMessage(const FGameplayCueParameters& Params)
{
	FProjectVerbMessage Result;
