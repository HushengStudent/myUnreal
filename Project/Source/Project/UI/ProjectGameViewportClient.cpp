...
#include UE_INLINE_GENERATED_CPP_BY_NAME(ProjectGameViewportClient)
...
UProjectGameViewportClient::UProjectGameViewportClient()
	: Super(FObjectInitializer::Get())
{
}

void UProjectGameViewportClient::Init(struct FWorldContext& WorldContext, UGameInstance* OwningGameInstance, bool bCreateNewAudioDevice)
{
